 ...
 */
public class CooccurenceUsingStripes extends Configured implements Tool {
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new CooccurenceUsingStripes(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(getConf(), "cooccurence-stripes");

        job.setJarByClass(CooccurenceUsingStripes.class);
